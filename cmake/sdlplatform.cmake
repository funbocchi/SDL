macro(SDL_DetectCMakePlatform)
  ...
  elseif(UNIX AND NOT APPLE AND NOT OHOS)
  ...
  elseif(OHOS)
    if(DEVICE_TYPE MATCHES ".*phone.*")
      set(SDL_CMAKE_PLATFORM OHPHONE)
    elseif(DEVICE_TYPE MATCHES ".*tablet.*")
      set(SDL_CMAKE_PLATFORM OHTABLET)
    elseif(DEVICE_TYPE MATCHES ".*2in1.*")
      set(SDL_CMAKE_PLATFORM OHPC)
    endif()
